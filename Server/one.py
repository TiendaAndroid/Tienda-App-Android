...
def one_redify_image(
    ...
    with Image.open(input_file_name) as input_file:
        ...
        pixin: PyAccess = cast(PyAccess, input_file.load()) # type: ignore
        width: int
        height: int
...
if __name__ == '__main__':
    one_redify_image('/Users/lucioarturoreyescastillo/Desktop/Quinto Semestre/Algoritmos Avanzados/Programas/2. Images/scarlett.png', 
                 '/Users/lucioarturoreyescastillo/Desktop/Quinto Semestre/Algoritmos Avanzados/Programas/2. Images/scarlett_prueba.png')
